...
# Python path (Windows)
PYTHON="/c/Users/taewoo/AppData/Local/Programs/Python/Python313/python.exe"
...
PARSED=$(echo "$INPUT_JSON" | $PYTHON -c '
import json
import sys
...
PARSED_OK=$(echo "$PARSED" | $PYTHON -c "import json,sys; print(json.load(sys.stdin).get('parsed', False))")
